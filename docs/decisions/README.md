...
| [ADR-004](ADR-004-provider-degradation.md) | 1 Sep 2026 | The provider is a component with four implementations and an extractive floor behind it, so the whole evaluation run completes with no API key. |

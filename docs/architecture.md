...
Validation (`src/guardrails.py`) answers whether what was written is safe to send. Five deterministic checks — private data, injection, grounding, commitments, confidence floor — all of them run every time, and none of them calls the model.
